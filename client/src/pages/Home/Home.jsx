...
export default function Home() {
  ...
  // location setup.
  const weatherLat = user?.lat ?? DEFAULT_LOCATION.lat;
  const weatherLng = user?.lng ?? DEFAULT_LOCATION.lng;
  const weatherLocationLabel = user?.location || DEFAULT_LOCATION.label;
